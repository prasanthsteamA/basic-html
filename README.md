...
As a tribute to the Indian Cricket team, we at SteamA wanted to build a ScoreBoard for our CricPro webiste. And we thought, who can do it better than our SteamA?
...
![Image description](https://github.com/prasanthsteamA/images/blob/main/output.png)
